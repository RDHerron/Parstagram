...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "RDHerron" => "rherron@bulldogs.aamu.edu" }
  # Or just: spec.author    = "RDHerron"
  # spec.authors            = { "RDHerron" => "rherron@bulldogs.aamu.edu" }
  # spec.social_media_url   = "https://twitter.com/RDHerron"
